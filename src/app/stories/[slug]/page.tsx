...
export default function StoryDetailPage() {
  ...
  const relatedCharacters = story ? allCharacters.filter(c => story.relatedCharacters.includes(c.slug)) : [];
  const relatedTemples = story ? allTemples.filter(tm => story.relatedTemples.includes(tm.slug)) : [];
