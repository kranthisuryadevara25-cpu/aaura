...
export default function VirtualPoojaPage() {
  ...
  const handleInteraction = async (interaction: 'ring-bell' | 'offer-flower' | 'light-diya' | 'offer-aarti') => {
    ...
    switch (interaction) {
      case 'ring-bell':
        new Audio('https://storage.googleapis.com/spec-host-backup/mio-design-assets/assets/v1/sounds/bell.mp3').play().catch(e => console.error("Error playing bell audio:", e));
        break;
      case 'offer-flower':
