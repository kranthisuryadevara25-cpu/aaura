...
export default function VirtualPoojaPage() {
  ...
  const handleInteraction = async (interaction: 'ring-bell' | 'offer-flower' | 'light-diya' | 'offer-aarti') => {
    ...
    switch (interaction) {
      case 'ring-bell':
        new Audio('https://cdn.pixabay.com/download/audio/2022/03/15/audio_06c9b9f2f8.mp3?filename=bell-chime-107566.mp3').play().catch(e => console.error("Error playing bell audio:", e));
        break;
      case 'offer-flower':
