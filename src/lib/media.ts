  ...
  export const media: Media[] = [
    {
        ...
        title_te: 'లోతైన ధ్యానం మరియు ఒత్తిడి ఉపశమనం కోసం సరైన ఈ ప్రశాంతమైన వేణువు శ్రావ్యతతో మీ మనస్సును ప్రశాంతంగా ఉంచుకోండి.',
        uploadDate: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(),
        mediaUrl: 'https://placehold.co/600x400.mp4?text=Audio+Player',
    ...
    },
    {
        ...
        mediaUrl: 'https://placehold.co/450x800.mp4?text=Shorts+Player',
    ...
    },
    {
        ...
        mediaUrl: 'https://placehold.co/800x450.mp4?text=Video+Player',
